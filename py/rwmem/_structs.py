...
class RegisterDataV3(ctypes.LittleEndianStructure):
    ...
    _fields_ = [
        ...
        (
            'description_offset',
            ctypes.c_uint32,
        ),  # Offset to register description (0 = no description)
        ...
        (
            'first_field_list_index',
            ctypes.c_uint32,
        ),  # Index of first field reference in FieldIndex array
        (
            'data_endianness',
            ctypes.c_uint8,
        ),  # Data encoding (0=inherit from block, 1=little, 2=big, 3=little-swapped, 4=big-swapped)
