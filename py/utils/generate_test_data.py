...
def generate_test_regs(output_path: str):
    ...
    sensor_a_regs = [
        ...
        gen.UnpackedRegister(
            ...
            'Maximum size register',
            reset_value=0x123456789ABCDEF0,
            data_size=8,
        ),
    ]
