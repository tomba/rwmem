...
class RwmemTestI2C(unittest.TestCase):
    ...
    def test_i2c(self):
        self.assertOutput(['0'], f'0x00 = {self.get_edid_u32(0)}\n')

        self.assertOutput(['4'], f'0x04 (+0x0) = {self.get_edid_u32(4)}\n')

        self.assertOutput(['-d', '8', '0x10'], f'0x10 (+0x0) = {self.get_edid_u8(0x10)}\n')

        self.assertOutput(['-d', '16le', '0x10'], f'0x10 (+0x0) = {self.get_edid_u16(0x10)}\n')

        self.assertOutput(['-d', '24le', '0x10'], f'0x10 (+0x0) = {self.get_edid_u24(0x10)}\n')

        self.assertOutput(['-d', '32le', '0x10'], f'0x10 (+0x0) = {self.get_edid_u32(0x10)}\n')
